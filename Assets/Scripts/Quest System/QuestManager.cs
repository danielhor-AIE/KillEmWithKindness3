...
public class QuestManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        foreach (var quest in CurrentQuests)
        {
            ...
            questObj.GetComponent<Button>().onClick.AddListener(call: delegate
            {
    ...
    {
        EventManager.Instance.QueueEvent(EnvironmentVariableTarget: new BuildingGameEvent(buildingName));
    }
